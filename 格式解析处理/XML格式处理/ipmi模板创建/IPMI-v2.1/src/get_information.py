...
class Get_message():
    ...
    :param excel_path: 需要安装的IPMI表格
    :param html:zabbix的网址
    :param user:zabbix的登录用户
    :param password: zabbix的登录密码
    :param save_json:ipmi保存的路径
    '''
...
if __name__ == '__main__':
    ...
    gm = Get_message(excel_path = excel_path, html = 'http://192.168.50.100:18080')
    gm.push_host()
    gm.get_value()